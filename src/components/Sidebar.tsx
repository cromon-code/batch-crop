...
import { Plus, Trash2, CheckCircle2, Image as ImageIcon, Copy, Layers, RotateCcw, Sparkles } from 'lucide-react';
import { AiEnhanceSettings } from './AiEnhanceSettings';
...
export const Sidebar: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'tasks' | 'enhance'>('tasks');
    ...
    <div className="w-80 h-full bg-zinc-900 border-r border-zinc-800 flex flex-col select-none">
      ...
      <div className="flex border-b border-zinc-800 bg-zinc-950/60 p-1.5 gap-1">
        <button
          ...
          className={`flex-1 py-1.5 px-2 rounded-lg font-semibold text-xs flex items-center justify-center space-x-1.5 transition ${
            activeTab === 'tasks'
        ...
        <button
          ...
          className={`flex-1 py-1.5 px-2 rounded-lg font-semibold text-xs flex items-center justify-center space-x-1.5 transition relative ${
            activeTab === 'enhance'
              ? 'bg-zinc-800 text-zinc-100 shadow-sm border border-zinc-700/60'
              : 'text-zinc-400 hover:text-zinc-200'
          }`}
        ...
        <>
          ...
          <div className="p-3 border-b border-zinc-800 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <h2 className="font-semibold text-xs text-zinc-200">タスク一覧</h2>
