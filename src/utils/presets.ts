...
export const ASPECT_PRESETS: AspectPreset[] = [
  { mode: '3:4', label: '3:4', ratio: 3 / 4, shortcut: '1' },
  { mode: '9:16', label: '9:16', ratio: 9 / 16, shortcut: '2' },
  { mode: '1:1', label: '1:1', ratio: 1, shortcut: '3' },
  { mode: '4:3', label: '4:3', ratio: 4 / 3, shortcut: '4' },
  { mode: '16:9', label: '16:9', ratio: 16 / 9, shortcut: '5' },
